...
main(int argc, char **argv)
{
  ...
  if(argc < 2){
  18:	00100793          	li	a5,1
  1c:	04a7d263          	bge	a5,a0,60 <main+0x60>
  ...
  40:	2c4080e7          	jalr	708(ra) # 300 <atoi>
  44:	00000097          	auipc	ra,0x0
  48:	474080e7          	jalr	1140(ra) # 4b8 <kill>
  for(i=1; i<argc; i++)
  4c:	00848493          	add	s1,s1,8
  50:	ff2494e3          	bne	s1,s2,38 <main+0x38>
  exit(0);
  54:	00000513          	li	a0,0
  ...
  64:	b4058593          	add	a1,a1,-1216 # ba0 <malloc+0x150>
  68:	00200513          	li	a0,2
  6c:	00001097          	auipc	ra,0x1
  70:	898080e7          	jalr	-1896(ra) # 904 <fprintf>
    exit(1);
  74:	00100513          	li	a0,1
  78:	00000097          	auipc	ra,0x0
  7c:	3f8080e7          	jalr	1016(ra) # 470 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5d4:	64850513          	add	a0,a0,1608 # c18 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 730:	49470713          	add	a4,a4,1172 # bc0 <malloc+0x170>
 ...
 7ec:	430b8b93          	add	s7,s7,1072 # c18 <digits>
 ...
 85c:	36090913          	add	s2,s2,864 # bb8 <malloc+0x168>
        while(*s != 0){
